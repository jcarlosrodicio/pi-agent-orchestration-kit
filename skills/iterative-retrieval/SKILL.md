...
After applying iterative retrieval:

- [ ] Initial broad query was dispatched before narrowing
- [ ] Each cycle scored relevance and identified gaps
- [ ] Search criteria were refined based on findings (not repeated)
- [ ] Maximum 3 cycles were used before proceeding
- [ ] Returned context includes files with relevance >= 0.7
